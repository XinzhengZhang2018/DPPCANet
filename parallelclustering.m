function result = parallelclustering(pixel_vector1,X1,pixel_vector2,X2)

[ylen, xlen] = size(X1);
options = [2.0; 100; 1e-5; 0];

[center1,U1,obj_fcn] = fcm(pixel_vector1,2,options);
...
clear U;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[center2,U2,obj_fcn] = fcm(pixel_vector2,2,options);
